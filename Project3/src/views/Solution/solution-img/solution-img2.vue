<template>
  <div class="solution-img2">
  <el-row>
  <el-col :xl="20" :lg="20" :md="23" :sm="23" :xs="22" class="solution-k">
  <el-col :span="12" class="solution-k-right" :style="{height:soluimgH+'px'}">
  <el-image :src="soluimglist.solutionImg" lazy style="width:100%" :class="{'el-image1':num==1}" @mouseover="over"
  @mouseleave="leave"></el-image>
  </el-col>
  <el-col :span="12" class="solution-k-left" :style="{height:soluimgH+'px'}">
...
export default {
  data(){
    return{
      soluimgH:350,
      soluimg1:'https://www.luxshare-ict.com/Upload/image/20180913/20180913140808_8816.jpg',
      num:null,
    }
  },
  watch: {
  ...
  methods:{
    ...
    tosoludetails(id){
      ...
      this.$router.push({ name: 'solutiondetails', params: { conlltion: 1 }})
    }
  }
}
</script>
