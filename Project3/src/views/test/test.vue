            ...
            >
              ...
              >
                <el-select
                  ...
                  @blur="selectblur(formLabelAlign.opinionCountry)"
                  @change="selectchange(formLabelAlign.opinionCountry)"
                >
                  <el-option
              ...
              >
                <el-select
                  ...
                  allow-create
                  default-first-option
                  @blur="selectblur(formLabelAlign.opinionJob)"
                  @change="selectchange(formLabelAlign.opinionJob)"
                >
                  <el-option
              ...
              >
                <el-select
                  ...
                  allow-create
                  default-first-option
                  @blur="selectblur(formLabelAlign.opinionInterest)"
                  @change="selectchange(formLabelAlign.opinionInterest)"
                >
                  <el-option
