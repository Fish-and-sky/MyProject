<template>
  <div class="swiper-container" ref="mySwiper">
    <div class="swiper-wrapper">
        ...
        <div class="rotation-img"><el-image  :src="item.rotationimg"></el-image></div>
        <div class="rotation-title">
        <div><span>全技科技</span><span style="color: rgb(179, 89, 89);font-size:3rem">厘米级高精度定位</span></div>
        <div><p>助力中铁巢湖大型养老社区智能化</p></div>
        <div>
...
Swiper.use([Navigation, Pagination ,Autoplay]);
  export default {
    data(){
        return{
            rotalist:[
                {id:0,rotationimg:'http://www.ubitraq.com/images/bg_banner_1.png'},
                {id:1,rotationimg:'http://www.ubitraq.com/images/bg_banner_2.jpg'},
                {id:2,rotationimg:'http://www.ubitraq.com/images/bg_banner_3.jpg'},
                {id:3,rotationimg:'http://www.ubitraq.com/images/bg_banner_4.jpg?v=1'},
                {id:4,rotationimg:'http://www.ubitraq.com/images/bg_banner_5.jpg'},
            ],
